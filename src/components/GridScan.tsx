// face-api.js (Webcam-Gesichtstracking) wurde bewusst entfernt — ~700 KB Bundle
// für ein Shop-Deko-Element. Maus-/Gyro-Interaktion bleibt vollständig erhalten.
...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  // Webcam-/Face-Tracking-Effekte entfernt (siehe Kommentar beim Import).
