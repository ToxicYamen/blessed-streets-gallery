                            ...
                            <div className="flex items-center">
                              ...
                              <div>
                                ...
                                <button
                                  ...
                                  className="text-mono-500 text-sm mt-2 flex items-center hover:text-mono-300 transition-colors"
                                >
                          ...
                          <td className="py-6">
                            <div className="flex items-center justify-center">
                              <button
                                ...
                                className="w-8 h-8 flex items-center justify-center border border-mono-700 rounded-full"
