    ...
    <div className="pt-24">
      ...
      <section className="py-16 bg-mono-800">
        <div className="blesssed-container">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">SEARCH RESULTS</h1>
          <p className="text-mono-400 max-w-2xl mb-6">
            {initialQuery ? `Results for "${initialQuery}"` : 'Browse all products'}
          </p>
